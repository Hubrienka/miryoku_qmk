...
LGUI_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_D),      KC_V,              KC_K,              LSFT_T(KC_H),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    KC_ENT,            \
U_NP,              U_NP,              LT(U_MEDIA,KC_BSLS),LT(U_NAV,KC_BSPC),LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_DEL),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_EQL),  U_NP,              U_NP
...
TD(U_TD_BOOT),     KC_1,              KC_2,              KC_3,              U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_LEFT,           KC_UP,             KC_DOWN,           KC_RGHT,           U_NA,              CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           \
KC_HOME,           KC_PGUP,           KC_PGDN,           KC_END,            U_NA,              KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_EQL,            KC_DEL,            U_NP,              U_NP
...
KC_ASTR,           KC_AT,             KC_HASH,           KC_PERC,           KC_AMPR,           U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_MINS,           KC_COLN,           KC_QUOT,           KC_QUES,           U_NA,              U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           \
KC_UNDS,           KC_SCLN,           KC_DQUO,           KC_EXLM,           U_NA,              U_NU,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP
...
KC_SCLN,           KC_4,              KC_5,              KC_6,              KC_NUBS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
KC_COLN,           KC_QUOT,           KC_EXLM,           KC_QUES,           KC_PPLS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           U_NA,              TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA),  KC_ALGR,           RGB_TOG,              \
