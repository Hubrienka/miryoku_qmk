...
U_NP,              U_NP,              LT(U_MEDIA,KC_BSLS),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC), LT(U_FUN,KC_EQL), U_NP,              U_NP
...
KC_COLN,           KC_QUOT,           KC_EXLM,           KC_QUES,        KC_PLUS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
