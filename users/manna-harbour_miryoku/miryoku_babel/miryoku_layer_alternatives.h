...
LGUI_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_M,              LSFT_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LGUI_T(KC_O),      \
LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_K,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_ENT),\
U_NP,              U_NP,              LT(U_MEDIA,KC_EQL),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_DEL),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_BSLS),  U_NP,              U_NP
...
KC_LBRC,           KC_7,              KC_8,              KC_9,              KC_RBRC,           U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_SCLN,           KC_4,              KC_5,              KC_6,              KC_EQL,            CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            \
U_NP,              U_NP,              KC_DOT,            U_NA,              KC_MINS,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
KC_LCBR,           KC_AMPR,           KC_ASTR,           KC_LPRN,           KC_RCBR,           U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
KC_COLN,           KC_DLR,            KC_PERC,           KC_CIRC,           KC_PLUS,           U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           \
KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           U_NU,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           \
U_NP,              U_NP,              KC_LPRN,           KC_RPRN,           U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP
...
KC_F12,            KC_F7,             KC_F8,             KC_F9,             KC_PSCR,           RGB_TOG,           RGB_MOD,           RGB_HUI,           RGB_SAI,           RGB_VAI,           \
KC_F11,            KC_F4,             KC_F5,             KC_F6,             KC_SCRL,           U_NU,              KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           \
KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           OU_AUTO,           U_NU,              U_NU,              U_NU,              U_NU,              \
U_NP,              U_NP,              U_NA,              KC_SPC,            KC_TAB,            KC_MUTE,           KC_MPLY,           U_NA,              U_NP,              U_NP
...
KC_COLN,           KC_DLR,            KC_PERC,           KC_CIRC,           KC_PLUS,           U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           \
KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           U_NU,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           \
U_NP,              U_NP,              KC_LPRN,           KC_RPRN,           KC_UNDS,           U_NA,              KC_BTN1,           KC_BTN3,           U_NP,              U_NP
...
KC_F11,            KC_F4,             KC_F5,             KC_F6,             KC_SCRL,           U_NU,              KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           \
KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           OU_AUTO,           U_NU,              U_NU,              U_NU,              U_NU,              \
U_NP,              U_NP,              KC_APP,            KC_SPC,            KC_TAB,            KC_MUTE,           KC_MPLY,           U_NA,              U_NP,              U_NP
